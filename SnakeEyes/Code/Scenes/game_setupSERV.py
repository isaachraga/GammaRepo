...
class GameSetupSERV:
    ...
    def render(self):
        ...
        game_code_text = self.HEADER_FONT.get_rect("GAME CODE: "+self.GC1+" - "+self.GC2)
        game_code_text.center = ((Settings.WIDTH / 2), Settings.HEADER_FONT_SIZE+100)
        self.HEADER_FONT.render_to(self.screen, game_code_text, "GAME CODE: "+self.GC1+" - "+self.GC2, Settings.COLOR_TEXT)
