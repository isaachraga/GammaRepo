...
class Game:
    ...
    def render(self):
        ...
        self.GAME_FONT.render_to(self.screen, (10, 370), "Press Num key for player (P1 == 1) to leave the round", (0, 0, 0))

        self.GAME_FONT.render_to(self.screen, (10, 480), "Round:", (0, 0, 0))
        self.GAME_FONT.render_to(self.screen, (10, 500), "P!: "+str(self.p1.tmpScore)+"   P2: "+str(self.p2.tmpScore)+"   P3: "+str(self.p3.tmpScore)+"   P4: "+str(self.p4.tmpScore), (0, 0, 0))
        self.GAME_FONT.render_to(self.screen, (10, 520), "Score:", (0, 0, 0))
        self.GAME_FONT.render_to(self.screen, (10, 540), "P!: "+str(self.p1.score)+"   P2: "+str(self.p2.score)+"   P3: "+str(self.p3.score)+"   P4: "+str(self.p4.score), (0, 0, 0))
